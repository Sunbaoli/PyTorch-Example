...
parser.add_argument('--hr_train_dataset', type=str, default='train_HR_x8_256/')
#parser.add_argument('--train_dataset', type=str, default='DIV2K_LR_aug_x8')
parser.add_argument('--train_dataset', type=str, default='train_LR_x8_32/')
...
parser.add_argument('--patch_size', type=int, default=12, help='Size of cropped HR image')
#parser.add_argument('--pretrained_sr', default=None, help='sr pretrained base model')
parser.add_argument('--pretrained_sr', default='./weights/x8/train_LR_x8_32/Server1DBPNdbpn_epoch_79.pth', help='sr pretrained base model')
#parser.add_argument('--pretrained', type=bool, default=False)
parser.add_argument('--pretrained', type=bool, default=False)
#parser.add_argument('--save_folder', default='./weights/', help='Location to save checkpoint models')
parser.add_argument('--save_folder', default='./weights/x8_4/', help='Location to save checkpoint models')
parser.add_argument('--prefix', default='dbpn', help='Location to save checkpoint models')
#x8_4 256-->32 patch 12
#x8_5 256--->32 patch 24
#/home/sunbaoli/DBPN-Pytorch/dataset/depth_map/data/train_x16/
