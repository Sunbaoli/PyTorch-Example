...
class DatasetFromFolder(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        elif self.dataset == 'depth_map/data/data_L_pic64/':
            input = load_img(os.path.join(self.lr_dir,os.path.splitext(file)[0]+'.png'))

        elif self.dataset == 'depth_map/data/data_L_pic32/':
            input = load_img(os.path.join(self.lr_dir,os.path.splitext(file)[0]+'.png'))
        
        elif self.dataset == 'depth_map/data/train_x16/':
            input = load_img(os.path.join(self.lr_dir,os.path.splitext(file)[0]+'.png'))

        elif self.dataset == 'train_LR_x8_f/':
            input = load_img(os.path.join(self.lr_dir,os.path.splitext(file)[0]+'.png'))

        elif self.dataset == 'train_LR_x8_32/':
            input = load_img(os.path.join(self.lr_dir,os.path.splitext(file)[0]+'.png'))
        ...
        #print(input.size(),'666666666666666666666666666666666666666666' ,target.size())
